...
public class ScreenCaptureEditor : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        GUILayout.Label("Screen Capture TATools", BigText);
    ...
    [MenuItem("TATools/Screenshots/打开窗口 &`", false, 0)]
    public static void ShowWindow()
    {
        GetWindow(typeof(ScreenCaptureEditor));
    }
 
    [MenuItem("TATools/Screenshots/存储路径 &2", false, 2)]
    ...
    [MenuItem("TATools/Screenshots/单张截图 &1", false, 1)]
